...
<body>
	...
	<div class="container offset-md-4">
		<h2>
			<i class="fa-solid fa-user-gear"></i>&nbsp Registration
		</h2>
		<form action="Register" method="post">
			<div class="form-group">
				<label for="password">Enter Full Name:</label> <input type="text"
					id="name" name="name" required>
			</div>
			<div class="form-group">
				<label for="password">Enter Qualification:</label> <input
					type="text" id="qualification" name="qua" required>
			</div>
			<div class="form-group">
